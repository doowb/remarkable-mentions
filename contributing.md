# Contributing to remarkable-mentions

First and foremost, thank you! We appreciate that you want to contribute to remarkable-mentions, your time is valuable, and your contributions mean a lot to us.
...
**Showing support for remarkable-mentions**

Please keep in mind that open source software is built by people like you, who spend their free time creating things the rest the community can use.

Don't have time to contribute? No worries, here are some other ways to show your support for remarkable-mentions:

- star the [project](https://github.com/doowb/remarkable-mentions)
- tweet your support for remarkable-mentions
...
- **version**: please note the version of remarkable-mentions are you using
...
[so]: http://stackoverflow.com/questions/tagged/remarkable-mentions